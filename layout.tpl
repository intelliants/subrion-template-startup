...
<div class="inventory">
        ...
        <nav class="navbar navbar-default {if $core.config.navbar_sticky}navbar-sticky{/if}">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-social pull-right hidden-xs">
        ...
        {if isset($iaBlocks.headline1) || isset($iaBlocks.headline2) || isset($iaBlocks.headline3) || isset($iaBlocks.headline4)}
            <div class="headline-blocks">
                <div class="container">
                    <div class="row">
                        <div class="{width section='headline-blocks' position='headline1' tag='col-md-'}">{ia_blocks block='headline1'}</div>
                        <div class="{width section='headline-blocks' position='headline2' tag='col-md-'}">{ia_blocks block='headline2'}</div>
                        <div class="{width section='headline-blocks' position='headline3' tag='col-md-'}">{ia_blocks block='headline3'}</div>
                        <div class="{width section='headline-blocks' position='headline4' tag='col-md-'}">{ia_blocks block='headline4'}</div>
                    </div>
                </div>
            </div>
        {/if}
