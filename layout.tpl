...
<html lang="{$core.language.iso}" dir="{$core.language.direction}">
	<head>
		...
		{switch $config.startup_font}
			{case 'PT Sans' break}
				<link href='//fonts.googleapis.com/css?family=PT+Sans:400,700,400italic{if $config.startup_font_subset}&subset=latin,cyrillic{/if}' rel='stylesheet' type='text/css'>
				<style type="text/css">
					body, select, textarea { font-family: 'PT Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; }
				</style>
			{case 'PT Serif' break}
				<link href='//fonts.googleapis.com/css?family=PT+Serif:400,700,400italic{if $config.startup_font_subset}&subset=latin,cyrillic{/if}' rel='stylesheet' type='text/css'>
				<style type="text/css">
					body, select, textarea { font-family: 'PT Serif', 'Helvetica Neue', Helvetica, Arial, sans-serif; }
				</style>
			{case 'Roboto' break}
				<link href='//fonts.googleapis.com/css?family=Roboto:400,700,400italic{if $config.startup_font_subset}&subset=latin,cyrillic{/if}' rel='stylesheet' type='text/css'>
				<style type="text/css">
	...
	<body class="page-{$core.page.name}">
		<header class="header"{if $config.startup_website_bg} style="background-image: url('{$smarty.const.IA_URL}uploads/{$config.startup_website_bg}');"{/if}>
			<div class="inventory">
				<div class="container">
